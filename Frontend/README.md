...
### what to Update ####
download resume in About section
projects
contact send message



Use JSZip to create a ZIP file containing the HTML, CSS, and JS files.
Use FileSaver.js to trigger the download of the ZIP file in the browser.
...
https://NakulKumar.onrender.com/


- resume
- resume in portfolio
- remove the builder part
- check health endpoint for uptimerobot
- builder backend kro:
   - build home page
   - build backend
